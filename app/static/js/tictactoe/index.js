...
function check_status(x) {
    if (x.status == 'draw') {
        ...
        $('.tbl .status').html("Its a Draw! <a href=\
        ''>Retry ?</a>")
        ...
        if (x.winner == 'ai') {
            ...
            <br>Do tell me how you did it!<br><a href=\
            ''>Retry ?</a>")
        }
    }
}
...
$(document).ready(function() {
    $(".btn").click(function() {
        ...
        if ($(this).hasClass("btn-o") == true) {
            ...
            ai_player = 'X'
            $.ajax({
                url: "/tictactoe/choose/" + user_player
            });
            ai_turn = false;
            $('.tbl .status').html(' Your Turn!')
